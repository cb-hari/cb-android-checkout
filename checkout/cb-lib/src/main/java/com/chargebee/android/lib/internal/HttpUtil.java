package com.chargebee.android.lib.internal;
...
import com.chargebee.android.lib.exceptions.InvalidRequestException;
import com.chargebee.android.lib.exceptions.OperationFailedException;
...
public class HttpUtil {
    ...
    private static HttpURLConnection createConnection(String url, Method m, Map<String,String> headers, Environment config)
            throws ProtocolException, IOException {
    ...
    private static void setTimeouts(HttpURLConnection conn, Environment config) {
