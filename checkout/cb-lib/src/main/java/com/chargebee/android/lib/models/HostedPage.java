...
public class HostedPage extends Resource<HostedPage> {
    ...
    public static class CheckoutNewRequest extends Request<CheckoutNewRequest> {
        ...
        public CheckoutNewRequest customerTaxability(com.chargebee.android.lib.models.enums.Taxability customerTaxability) {
        ...
        public CheckoutNewRequest subscriptionAutoCollection(com.chargebee.android.lib.models.enums.AutoCollection subscriptionAutoCollection) {
        ...
        @Deprecated
        public CheckoutNewRequest cardGateway(com.chargebee.android.lib.models.enums.Gateway cardGateway) {
        ...
        public CheckoutNewRequest billingAddressValidationStatus(com.chargebee.android.lib.models.enums.ValidationStatus billingAddressValidationStatus) {
        ...
        public CheckoutNewRequest shippingAddressValidationStatus(com.chargebee.android.lib.models.enums.ValidationStatus shippingAddressValidationStatus) {
    ...
    public static class CheckoutExistingRequest extends Request<CheckoutExistingRequest> {
        ...
        @Deprecated
        public CheckoutExistingRequest cardGateway(com.chargebee.android.lib.models.enums.Gateway cardGateway) {
            params.addOpt("card[gateway]", cardGateway);
            return this;
        }
    ...
    public static class UpdateCardRequest extends Request<UpdateCardRequest> {
        ...
        @Deprecated
        public UpdateCardRequest cardGateway(com.chargebee.android.lib.models.enums.Gateway cardGateway) {
            params.addOpt("card[gateway]", cardGateway);
            return this;
        }
    ...
    public static class UpdatePaymentMethodRequest extends Request<UpdatePaymentMethodRequest> {
        ...
        @Deprecated
        public UpdatePaymentMethodRequest cardGateway(com.chargebee.android.lib.models.enums.Gateway cardGateway) {
            params.addOpt("card[gateway]", cardGateway);
            return this;
        }
